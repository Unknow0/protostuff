...
public final class UnsignedNumbers implements Externalizable, Message<UnsignedNumbers>, Schema<UnsignedNumbers> {
	...
	public boolean equals(Object obj) {
		...
		return equals(this.uint32, that.uint32) && equals(this.uint64, that.uint64) && equals(this.fixed32, that.fixed32) && equals(this.fixed64, that.fixed64);
	}
	...
	public String toString() {
		return "UnsignedNumbers{" + "uint32=" + uint32 + ", uint64=" + uint64 + ", fixed32=" + fixed32 + ", fixed64=" + fixed64 + '}';
	}

...
public class GraphTest extends AbstractTest {
	...
	public static <T> byte[] toByteArray(T message, Schema<T> schema) throws IOException {
		return GraphIOUtil.toByteArray(message, schema);
	}

	public static <T> void mergeFrom(byte[] data, T message, Schema<T> schema) throws IOException {
		GraphIOUtil.mergeFrom(data, 0, data.length, message, schema);
	}
	...
	public void testReference() throws Exception {
		...
		mergeFrom(data, fooFromByteArray, Foo.getSchema());
	...
	public void testCyclic() throws Exception {
		...
		mergeFrom(data, founderFromByteArray, ClubFounder.getSchema());

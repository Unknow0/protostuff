...
public class ProtobufOutputTest {
	...
	public void testGetTagAndRawLittleEndian64Bytes() {
		Assert.assertArrayEquals(new byte[] { -52, 70, -56, -120, -53, -54, -55, -53, -56, -57 }, ProtobufOutput.getTagAndRawLittleEndian64Bytes(9036, 0xC7C8CBC9CACB88C8L));
	...
	public void testGetTagAndRawVarInt32Bytes() {
		Assert.assertArrayEquals(new byte[] { 6, -128, 2 }, ProtobufOutput.getTagAndRawVarInt32Bytes(6, 256));
	...
	public void testWriteRawVarInt32() {
		...
		Assert.assertArrayEquals(new byte[] { 0, 0, -0x33, -0x08, -0x54, -0x2F, 0x01, 0 }, buf);
	}
	...
	public void testWriteRawLittleEndian32() {
		...
		Assert.assertEquals(4, ProtobufOutput.writeRawLittleEndian32(0x1A2B3C4D, buf, 2));

		Assert.assertArrayEquals(new byte[] { 0, 0, 0x4D, 0x3C, 0x2B, 0x1A, 0, 0 }, buf);
	}
	...
	public void testWriteRawLittleEndian64() {
		...
		Assert.assertEquals(8, ProtobufOutput.writeRawLittleEndian64(0x1A2B3C4D1A2B3C4DL, buf, 1));

		Assert.assertArrayEquals(new byte[] { 0, 0x4D, 0x3C, 0x2B, 0x1A, 0x4D, 0x3C, 0x2B, 0x1A, 0 }, buf);
	}

...
public final class ArraySchemas {
	...
	static final int ID_ARRAY_LEN = 1, ID_ARRAY_DATA = 2, ID_ARRAY_NULLCOUNT = 3;

	static final String STR_ARRAY_LEN = "a", STR_ARRAY_DATA = "b", STR_ARRAY_NULLCOUNT = "c";
		...
		protected void writeTo(Output output, Object value, boolean primitive) throws IOException {
			if (primitive) {
				...
				for (boolean element : array) {
					output.writeBool(ID_ARRAY_DATA, element, true);
				}
		...
		protected void writeTo(Output output, Object value, boolean primitive) throws IOException {
			if (primitive) {
				...
				for (char element : array) {
					output.writeUInt32(ID_ARRAY_DATA, element, true);
				}
		...
		protected void writeTo(Output output, Object value, boolean primitive) throws IOException {
			if (primitive) {
				...
				for (int element : array) {
					output.writeInt32(ID_ARRAY_DATA, element, true);
				}
		...
		protected void writeTo(Output output, Object value, boolean primitive) throws IOException {
			if (primitive) {
				...
				for (long element : array) {
					output.writeInt64(ID_ARRAY_DATA, element, true);
				}
		...
		protected void writeTo(Output output, Object value, boolean primitive) throws IOException {
			if (primitive) {
				...
				for (float element : array) {
					output.writeFloat(ID_ARRAY_DATA, element, true);
				}
		...
		protected void writeTo(Output output, Object value, boolean primitive) throws IOException {
			if (primitive) {
				...
				for (double element : array) {
					output.writeDouble(ID_ARRAY_DATA, element, true);
				}

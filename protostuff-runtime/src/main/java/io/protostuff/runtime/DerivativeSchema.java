...
public abstract class DerivativeSchema implements Schema<Object> {
	...
	public void writeTo(final Output output, final Object value) throws IOException {
		final Schema<Object> schema = strategy.writePojoIdTo(output, ID_POJO, (Class<Object>) value.getClass()).getSchema();
	 ...
	 */
	public final Pipe.Schema<Object> pipeSchema = new Pipe.Schema<Object>(DerivativeSchema.this) {
		@Override
		public void transfer(Pipe pipe, Input input, Output output) throws IOException {
			...
			final Pipe.Schema<Object> pipeSchema = strategy.transferPojoId(input, output, ID_POJO).getPipeSchema();

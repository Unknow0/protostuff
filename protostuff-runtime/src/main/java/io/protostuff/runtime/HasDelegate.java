...
public class HasDelegate<T> implements PolymorphicSchema.Factory {
	...
	public HasDelegate(Delegate<T> delegate, IdStrategy strategy) {
		...
		genericElementSchema = new ArraySchemas.DelegateArray(strategy, ArraySchemas.GENERIC_HANDLER, (Delegate<Object>) delegate);
	}
	...
	@Override
	@SuppressWarnings("unchecked")
	public final PolymorphicSchema newSchema(Class<?> typeClass, IdStrategy strategy, Handler handler) {
		return new ArraySchemas.DelegateArray(strategy, handler, (Delegate<Object>) delegate);
	}

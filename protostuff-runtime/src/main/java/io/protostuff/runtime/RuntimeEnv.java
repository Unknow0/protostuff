...
public final class RuntimeEnv {
	...
	static {
		...
		ALWAYS_USE_SUN_REFLECTION_FACTORY = OBJECT_CONSTRUCTOR != null
				&& Boolean.parseBoolean(props.getProperty("protostuff.runtime.always_use_sun_reflection_factory", "false"));

		NEVER_USE_SUN_REFLECTION_FACTORY = Boolean.parseBoolean(props.getProperty("protostuff.runtime.never_use_sun_reflection_factory", "false"));

...
final class RuntimeMapFieldFactory {
	...
	private static <T> Field<T> createMapInlineKEnumV(int number, String name, final java.lang.reflect.Field f, MessageFactory messageFactory, final Delegate<Object> inlineK,
		...
		return new RuntimeMapField<T, Object, Enum<?>>(FieldType.MESSAGE, number, name, f.getAnnotation(Tag.class), messageFactory) {
			...
			protected void mergeFrom(Input input, T message) throws IOException {
				accessor.set(message, input.mergeObject((Map<Object, Enum<?>>) accessor.get(message), schema));
			}
			...
			@Override
			protected Object kFrom(Input input, MapWrapper<Object, Enum<?>> wrapper) throws IOException {
				return inlineK.readFrom(input);
			}

			@Override
			protected void kTo(Output output, int fieldNumber, Object key, boolean repeated) throws IOException {
				inlineK.writeTo(output, fieldNumber, key, repeated);
			}

			@Override
			protected void kTransfer(Pipe pipe, Input input, Output output, int number, boolean repeated) throws IOException {
				inlineK.transfer(pipe, input, output, number, repeated);
			}

			@Override
			protected void vPutFrom(Input input, MapWrapper<Object, Enum<?>> wrapper, Object key) throws IOException {
				wrapper.put(key, eioV.readFrom(input));
			}

			@Override
			protected void vTo(Output output, int fieldNumber, Enum<?> val, boolean repeated) throws IOException {
				eioV.writeTo(output, fieldNumber, repeated, val);
			}

			@Override
			protected void vTransfer(Pipe pipe, Input input, Output output, int number, boolean repeated) throws IOException {
	...
	private static <T> Field<T> createMapInlineKInlineV(int number, String name, final java.lang.reflect.Field f, MessageFactory messageFactory,
		...
		return new RuntimeMapField<T, Object, Object>(FieldType.MESSAGE, number, name, f.getAnnotation(Tag.class), messageFactory) {
			...
			@SuppressWarnings("unchecked")
			protected void mergeFrom(Input input, T message) throws IOException {
				accessor.set(message, input.mergeObject((Map<Object, Object>) accessor.get(message), schema));
			}
			...
			@Override
			protected Object kFrom(Input input, MapWrapper<Object, Object> wrapper) throws IOException {
				return inlineK.readFrom(input);
			}
			...
			@Override
			protected void vPutFrom(Input input, MapWrapper<Object, Object> wrapper, Object key) throws IOException {
				wrapper.put(key, inlineV.readFrom(input));
			}

			@Override
			protected void vTo(Output output, int fieldNumber, Object val, boolean repeated) throws IOException {
	...
	private static <T> Field<T> createMapInlineKPojoV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory,
			...
			protected void vTo(Output output, int fieldNumber, Object val, boolean repeated) throws IOException {
				if (!clazzV.isAssignableFrom(val.getClass())) {
					throw new RuntimeException(
							f.getDeclaringClass().getName() + "::" + f.getName() + " - " + val.getClass().getName() + " is not assignable to " + clazzV.getName());
				}
	...
	private static <T> Field<T> createMapInlineKPolymorphicV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory,
		...
		return new RuntimeMapField<T, Object, Object>(FieldType.MESSAGE, number, name, f.getAnnotation(Tag.class), messageFactory) {
			...
			@Override
			protected void vPutFrom(Input input, MapWrapper<Object, Object> wrapper, Object key) throws IOException {
				final Object value = input.mergeObject(wrapper, strategy.POLYMORPHIC_POJO_ELEMENT_SCHEMA);
				if (value != wrapper) {
					// referenced.
			...
			protected void vTo(Output output, int fieldNumber, Object val, boolean repeated) throws IOException {
				...
				output.writeObject(fieldNumber, val, strategy.POLYMORPHIC_POJO_ELEMENT_SCHEMA, repeated);
			}
	...
	private static <T> Field<T> createMapEnumKEnumV(int number, String name, final java.lang.reflect.Field f, MessageFactory messageFactory, final Class<Object> clazzK,
			final Class<Object> clazzV, final IdStrategy strategy) {
		...
		return new RuntimeMapField<T, Enum<?>, Enum<?>>(FieldType.MESSAGE, number, name, f.getAnnotation(Tag.class), messageFactory) {
			...
			@SuppressWarnings("unchecked")
			protected void mergeFrom(Input input, T message) throws IOException {
				accessor.set(message, input.mergeObject((Map<Enum<?>, Enum<?>>) accessor.get(message), schema));
			}
			...
			@Override
			protected Enum<?> kFrom(Input input, MapWrapper<Enum<?>, Enum<?>> wrapper) throws IOException {
				return eioK.readFrom(input);
			}

			@Override
			protected void kTo(Output output, int fieldNumber, Enum<?> key, boolean repeated) throws IOException {
			...
			@Override
			protected void vPutFrom(Input input, MapWrapper<Enum<?>, Enum<?>> wrapper, Enum<?> key) throws IOException {
				wrapper.put(key, eioV.readFrom(input));
			}
	...
	private static <T> Field<T> createMapEnumKInlineV(int number, String name, final java.lang.reflect.Field f, MessageFactory messageFactory, final Class<Object> clazzK,
		...
		return new RuntimeMapField<T, Enum<?>, Object>(FieldType.MESSAGE, number, name, f.getAnnotation(Tag.class), messageFactory) {
			...
			@SuppressWarnings("unchecked")
			protected void mergeFrom(Input input, T message) throws IOException {
				accessor.set(message, input.mergeObject((Map<Enum<?>, Object>) accessor.get(message), schema));
			}
			...
			@Override
			protected Enum<?> kFrom(Input input, MapWrapper<Enum<?>, Object> wrapper) throws IOException {
				return eioK.readFrom(input);
			}
			...
			@Override
			protected void vPutFrom(Input input, MapWrapper<Enum<?>, Object> wrapper, Enum<?> key) throws IOException {
				wrapper.put(key, inlineV.readFrom(input));
			}
	...
	private static <T> Field<T> createMapEnumKPojoV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory, final Class<Object> clazzK,
			final Class<Object> clazzV, final IdStrategy strategy) {
		final EnumIO<?> eioK = strategy.getEnumIO(clazzK);
		final HasSchema<Object> schemaV = strategy.getSchemaWrapper(clazzV, true);
	...
	private static <T> Field<T> createMapEnumKPolymorphicV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory,
	...
	private static <T> Field<T> createMapEnumKObjectV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory,
	...
	private static <T> Field<T> createMapPojoKEnumV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory, final Class<Object> clazzK,
			final Class<Object> clazzV, final IdStrategy strategy) {
		...
		return new RuntimeMapField<T, Object, Enum<?>>(FieldType.MESSAGE, number, name, f.getAnnotation(Tag.class), messageFactory) {
			...
			protected void kTo(Output output, int fieldNumber, Object key, boolean repeated) throws IOException {
				if (!clazzK.isAssignableFrom(key.getClass())) {
					throw new RuntimeException(
							f.getDeclaringClass().getName() + "::" + f.getName() + " - " + key.getClass().getName() + " is not assignable to " + clazzK.getName());
				}
	...
	private static <T> Field<T> createMapPojoKInlineV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory,
	...
	private static <T> Field<T> createMapPojoKPojoV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory, final Class<Object> clazzK,
	...
	private static <T> Field<T> createMapPojoKPolymorphicV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory,
			final Class<Object> clazzK, final Class<Object> clazzV, final IdStrategy strategy) {
		final HasSchema<Object> schemaK = strategy.getSchemaWrapper(clazzK, true);
	...
	private static <T> Field<T> createMapPojoKObjectV(int number, String name, final java.lang.reflect.Field f, final MessageFactory messageFactory,
			final Class<Object> clazzK, final Schema<Object> valueSchema, final Pipe.Schema<Object> valuePipeSchema, final IdStrategy strategy) {
		final HasSchema<Object> schemaK = strategy.getSchemaWrapper(clazzK, true);
	...
	static final RuntimeFieldFactory<Map<?, ?>> MAP = new RuntimeFieldFactory<Map<?, ?>>(RuntimeFieldFactory.ID_MAP) {
		...
		public <T> Field<T> create(int number, String name, final java.lang.reflect.Field f, IdStrategy strategy) {
			...
			if (0 != (IdStrategy.POJO_SCHEMA_ON_MAP_FIELDS & strategy.flags) && (morph == null || morph.value())) {
				if (!clazz.getName().startsWith("java.util") && pojo(clazz, morph, strategy)) {
			...
			if (clazzK == null || 2 != ((ParameterizedType) f.getGenericType()).getActualTypeArguments().length
			...
			if (clazzV == null || ((Map.class.isAssignableFrom(clazzV) || Collection.class.isAssignableFrom(clazzV)) && !strategy.isRegistered(clazzV))) {
				...
				if (Message.class.isAssignableFrom(clazzK)) {
					return createMapPojoKObjectV(number, name, f, messageFactory, clazzK, strategy.OBJECT_ELEMENT_SCHEMA, strategy.OBJECT_ELEMENT_SCHEMA.pipeSchema, strategy);
				}

				if (clazzK.isEnum()) {
					return createMapEnumKObjectV(number, name, f, messageFactory, clazzK, strategy.OBJECT_ELEMENT_SCHEMA, strategy.OBJECT_ELEMENT_SCHEMA.pipeSchema, strategy);
				}
			...
			if (clazzK.isEnum()) {
				...
				final PolymorphicSchema psV = PolymorphicSchemaFactories.getSchemaFromCollectionOrMapGenericType(clazzV, strategy);
				if (psV != null) {
					return createMapEnumKObjectV(number, name, f, messageFactory, clazzK, psV, psV.getPipeSchema(), strategy);
				}
			...
			if (pojo(clazzK, f.getAnnotation(Morph.class), strategy)) {
				...
				final PolymorphicSchema psV = PolymorphicSchemaFactories.getSchemaFromCollectionOrMapGenericType(clazzV, strategy);
				if (psV != null) {
					return createMapPojoKObjectV(number, name, f, messageFactory, clazzK, psV, psV.getPipeSchema(), strategy);
				}

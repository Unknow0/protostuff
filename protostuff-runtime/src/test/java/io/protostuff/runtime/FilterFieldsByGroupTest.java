...
public class FilterFieldsByGroupTest extends AbstractTest {
	...
	static class Inner {
		...
		public String toString() {
			return "Inner [propAll=" + propAll + ", prop1a=" + prop1a + ", prop1b=" + prop1b + ", prop2a=" + prop2a + ", prop2b=" + prop2b + ", prop3a=" + prop3a + ", prop3b="
					+ prop3b + ", prop1and2a=" + prop1and2a + ", prop1and2b=" + prop1and2b + ", prop1and3a=" + prop1and3a + ", prop1and3b=" + prop1and3b + ", prop2and3a="
	...
	public static final class Ent_Network {
		...
		@Override
		public String toString() {
			return "Ent_Network [code=" + code + ", networkType=" + networkType + ", networkLocations=" + networkLocations + ", mainNetworkLocation=" + mainNetworkLocation
					+ "]";
		}
	}
	...
	public static final class Ent_Location {
		...
		@Override
		public String toString() {
			return "Ent_Location [code=" + code + ", networkLocations=" + networkLocations + ", sub=" + sub + "]";
		}
	}
	...
	static Ent_NetworkLocation newNetLocation(String code) {
		...
		location.networkLocations = new java.util.HashSet<>();
	...
	public void testNetwork() {
		...
		network.networkLocations = new java.util.HashSet<>();

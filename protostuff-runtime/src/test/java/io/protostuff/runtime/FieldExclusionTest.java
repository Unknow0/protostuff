...
public class FieldExclusionTest {
	...
	public void testComplexFieldsPojo() {
		...
		Class<?> expectedCollectionClass = RuntimeEnv.COLLECTION_SCHEMA_ON_REPEATED_FIELDS ? RuntimeCollectionField.class : RuntimeObjectField.class;

		assertAssignable(mappedSchema.getFieldByName("someCollectionValueArray"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someCollectionValueCollection"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someCollectionValueList"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someCollectionValueSet"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someCollectionValueMap"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someCollectionValueObject"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someCollectionValueWildcard"), expectedCollectionClass);

		assertAssignable(mappedSchema.getFieldByName("someListValueArray"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someListValueCollection"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someListValueList"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someListValueSet"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someListValueMap"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someListValueObject"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someListValueWildcard"), expectedCollectionClass);

		assertAssignable(mappedSchema.getFieldByName("someSetValueArray"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someSetValueCollection"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someSetValueList"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someSetValueSet"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someSetValueMap"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someSetValueObject"), expectedCollectionClass);
		assertAssignable(mappedSchema.getFieldByName("someSetValueWildcard"), expectedCollectionClass);

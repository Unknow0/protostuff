...
public class LazyRegisterTest extends AbstractTest {
	...
	public void testIt() throws IOException {
		...
		assertTrue(objParsed.olist != null && objParsed.olist.size() == 1 && objParsed.olist.get(0) instanceof MainData);
		verifyEquals(testdata, (MainData) objParsed.olist.get(0));

		assertTrue(objParsed.list != null && objParsed.list.size() == 1);
		verifyEquals(testdata, objParsed.list.get(0));

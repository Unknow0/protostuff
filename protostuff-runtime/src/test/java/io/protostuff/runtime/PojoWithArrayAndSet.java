...
public final class PojoWithArrayAndSet implements Serializable {
	...
	public PojoWithArrayAndSet(Set<Status> someEnumAsSet, Status[] someEnumAsArray, Set<Bar> someBarAsSet, Bar[] someBarAsArray, Set<Float> someFloatAsSet,
			Float[] someFloatAsArray, Double[] someDoubleAsArray, double[] somePrimitiveDoubleAsArray) {
	...
	private void writeObject(ObjectOutputStream out) throws IOException {
		byte[] data = ProtostuffIOUtil.toByteArray(this, RuntimeSchema.getSchema(PojoWithArrayAndSet.class), LinkedBuffer.allocate(LinkedBuffer.DEFAULT_BUFFER_SIZE));

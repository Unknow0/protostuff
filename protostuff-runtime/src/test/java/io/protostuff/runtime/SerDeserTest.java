...
public class SerDeserTest extends AbstractTest {
	...
	static PojoWithArrayAndSet filledPojoWithArrayAndSet() {
		...
		return new PojoWithArrayAndSet(someEnumAsSet, someEnumAsSet.toArray(new Status[someEnumAsSet.size()]), someBarAsSet,
				someBarAsSet.toArray(new Bar[someBarAsSet.size()]), someFloatAsSet, someFloatAsSet.toArray(new Float[someFloatAsSet.size()]),
				new Double[] { 112233.332211d, 445566.665544d }, new double[] { -112233.332211d, -445566.665544d });
	}

...
public final class SerializableObjects {
	...
	public static Foo newFoo(Integer[] someInt, String[] someString, Bar[] someBar, EnumSample[] someEnum, ByteString[] someBytes, Boolean[] someBoolean, Float[] someFloat,
		...
		return new Foo(Arrays.asList(someInt), Arrays.asList(someString), Arrays.asList(someBar), Arrays.asList(someEnum), Arrays.asList(someBytes),
				Arrays.asList(someBoolean), Arrays.asList(someFloat), Arrays.asList(someDouble), Arrays.asList(someLong));
	}

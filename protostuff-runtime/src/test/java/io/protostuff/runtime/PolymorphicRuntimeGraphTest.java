...
public class PolymorphicRuntimeGraphTest extends AbstractTest {
	...
	public void testPolymorphicAndCyclic() throws Exception {
		Schema<HtmlDocumentRequest> schema = RuntimeSchema.getSchema(HtmlDocumentRequest.class);
	...
	public void testPolymorphicSelfReference() throws Exception {
		Schema<LinkedElementContainer> schema = RuntimeSchema.getSchema(LinkedElementContainer.class);

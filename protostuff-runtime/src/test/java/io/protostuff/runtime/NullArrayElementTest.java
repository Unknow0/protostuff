...
public abstract class NullArrayElementTest extends AbstractTest {
	...
	final DefaultIdStrategy strategy = new DefaultIdStrategy(IdStrategy.DEFAULT_FLAGS | IdStrategy.PRESERVE_NULL_ELEMENTS);
	...
	public static final class PojoWithNonPrimitiveArrays {
		...
		public PojoWithNonPrimitiveArrays(Boolean[] boolArray, Character[] charArray, Short[] shortArray, Integer[] intArray, Long[] longArray, Float[] floatArray,
				Double[] doubleArray, String[] stringArray, ByteString[] byteStringArray, byte[][] byteArrayArray, BigDecimal[] bigDecimalArray, BigInteger[] bigIntegerArray,
				Date[] dateArray, Size[] sizeArray, SomePojo[] somePojoArray) {
		...
		public String toString() {
			return "PojoWithNonPrimitiveArrays [boolArray=" + Arrays.toString(boolArray) + ", boolList=" + boolList + ", charArray=" + Arrays.toString(charArray)
					+ ", charList=" + charList + ", shortArray=" + Arrays.toString(shortArray) + ", shortList=" + shortList + ", intArray=" + Arrays.toString(intArray)
					+ ", intList=" + intList + ", longArray=" + Arrays.toString(longArray) + ", longList=" + longList + ", floatArray=" + Arrays.toString(floatArray)
					+ ", floatList=" + floatList + ", doubleArray=" + Arrays.toString(doubleArray) + ", doubleList=" + doubleList + ", stringArray="
					+ Arrays.toString(stringArray) + ", stringList=" + stringList + ", byteStringArray=" + Arrays.toString(byteStringArray) + ", byteStringList="
					+ byteStringList + ", byteArrayArray=" + Arrays.toString(byteArrayArray) + ", byteArrayList=" + byteArrayList + ", bigDecimalArray="
					+ Arrays.toString(bigDecimalArray) + ", bigDecimalList=" + bigDecimalList + ", bigIntegerArray=" + Arrays.toString(bigIntegerArray) + ", bigIntegerList="
					+ bigIntegerList + ", dateArray=" + Arrays.toString(dateArray) + ", dateList=" + dateList + ", sizeArray=" + Arrays.toString(sizeArray) + ", sizeList="
					+ sizeList + ", somePojoArray=" + Arrays.toString(somePojoArray) + ", somePojoList=" + somePojoList + "]";
		}
	}

	public void testNullAll() throws IOException {
		Schema<PojoWithNonPrimitiveArrays> schema = getSchema(PojoWithNonPrimitiveArrays.class);

		Pipe.Schema<PojoWithNonPrimitiveArrays> pipeSchema = ((RuntimeSchema<PojoWithNonPrimitiveArrays>) schema).getPipeSchema();

		PojoWithNonPrimitiveArrays p = new PojoWithNonPrimitiveArrays(new Boolean[] { null, null, null }, new Character[] { null, null, null },
				new Short[] { null, null, null }, new Integer[] { null, null, null }, new Long[] { null, null, null }, new Float[] { null, null, null },
				new Double[] { null, null, null }, new String[] { null, null, null }, new ByteString[] { null, null, null }, new byte[][] { null, null, null },
				new BigDecimal[] { null, null, null }, new BigInteger[] { null, null, null }, new Date[] { null, null, null }, new Size[] { null, null, null },
	...
	public void testNullFirst() throws IOException {
		...
		PojoWithNonPrimitiveArrays p = new PojoWithNonPrimitiveArrays(new Boolean[] { null, true, false }, new Character[] { null, 'a', 'b' }, new Short[] { null, 1, 2 },
				new Integer[] { null, 1, 2 }, new Long[] { null, 1l, 2l }, new Float[] { null, 1.1f, 2.2f }, new Double[] { null, 1.1d, 2.2d },
				new String[] { null, "a", "b" }, new ByteString[] { null, ByteString.copyFromUtf8("a"), ByteString.copyFromUtf8("b") },
				new byte[][] { null, new byte[] { 'a' }, new byte[] { 'b' } }, new BigDecimal[] { null, new BigDecimal(1.1d), new BigDecimal(2.2d) },
				new BigInteger[] { null, new BigInteger("1"), new BigInteger("2") }, new Date[] { null, new Date(), new Date() }, new Size[] { null, Size.MEDIUM, Size.LARGE },
	...
	public void testNullLast() throws IOException {
		...
		PojoWithNonPrimitiveArrays p = new PojoWithNonPrimitiveArrays(new Boolean[] { true, false, null }, new Character[] { 'a', 'b', null }, new Short[] { 1, 2, null },
				new Integer[] { 1, 2, null }, new Long[] { 1l, 2l, null }, new Float[] { 1.1f, 2.2f, null }, new Double[] { 1.1d, 2.2d, null },
				new String[] { "a", "b", null }, new ByteString[] { ByteString.copyFromUtf8("a"), ByteString.copyFromUtf8("b"), null },
				new byte[][] { new byte[] { 'a' }, new byte[] { 'b' }, null }, new BigDecimal[] { new BigDecimal(1.1d), new BigDecimal(2.2d), null },
				new BigInteger[] { new BigInteger("1"), new BigInteger("2"), null }, new Date[] { new Date(), new Date(), null }, new Size[] { Size.MEDIUM, Size.LARGE, null },
	...
	public void testNullMid() throws IOException {
		...
		PojoWithNonPrimitiveArrays p = new PojoWithNonPrimitiveArrays(new Boolean[] { true, null, false }, new Character[] { 'a', null, 'b' }, new Short[] { 1, null, 2 },
				new Integer[] { 1, null, 2 }, new Long[] { 1l, null, 2l }, new Float[] { 1.1f, null, 2.2f }, new Double[] { 1.1d, null, 2.2d },
				new String[] { "a", null, "b" }, new ByteString[] { ByteString.copyFromUtf8("a"), null, ByteString.copyFromUtf8("b") },
				new byte[][] { new byte[] { 'a' }, null, new byte[] { 'b' } }, new BigDecimal[] { new BigDecimal(1.1d), null, new BigDecimal(2.2d) },
				new BigInteger[] { new BigInteger("1"), null, new BigInteger("2") }, new Date[] { new Date(), null, new Date() }, new Size[] { Size.MEDIUM, null, Size.LARGE },
	...
	public void testNullFirstAndLast() throws IOException {
		...
		PojoWithNonPrimitiveArrays p = new PojoWithNonPrimitiveArrays(new Boolean[] { null, true, false, null }, new Character[] { null, 'a', 'b', null },
				new Short[] { null, 1, 2, null }, new Integer[] { null, 1, 2, null }, new Long[] { null, 1l, 2l, null }, new Float[] { null, 1.1f, 2.2f, null },
				new Double[] { null, 1.1d, 2.2d, null }, new String[] { null, "a", "b", null },
				new ByteString[] { null, ByteString.copyFromUtf8("a"), ByteString.copyFromUtf8("b"), null },
				new byte[][] { null, new byte[] { 'a' }, new byte[] { 'b' }, null }, new BigDecimal[] { null, new BigDecimal(1.1d), new BigDecimal(2.2d), null },
				new BigInteger[] { null, new BigInteger("1"), new BigInteger("2"), null }, new Date[] { null, new Date(), new Date(), null },
				new Size[] { null, Size.MEDIUM, Size.LARGE, null }, new SomePojo[] { null, new SomePojo("a"), new SomePojo("b"), null });
	...
	public void testNullInBetween() throws IOException {
		...
		PojoWithNonPrimitiveArrays p = new PojoWithNonPrimitiveArrays(new Boolean[] { null, true, null, false, null }, new Character[] { null, 'a', null, 'b', null },
				new Short[] { null, 1, null, 2, null }, new Integer[] { null, 1, null, 2, null }, new Long[] { null, 1l, null, 2l, null },
				new Float[] { null, 1.1f, null, 2.2f, null }, new Double[] { null, 1.1d, null, 2.2d, null }, new String[] { null, "a", null, "b", null },
				new ByteString[] { null, ByteString.copyFromUtf8("a"), null, ByteString.copyFromUtf8("b"), null },
				new byte[][] { null, new byte[] { 'a' }, null, new byte[] { 'b' }, null }, new BigDecimal[] { null, new BigDecimal(1.1d), null, new BigDecimal(2.2d), null },
				new BigInteger[] { null, new BigInteger("1"), null, new BigInteger("2"), null }, new Date[] { null, new Date(), null, new Date(), null },
				new Size[] { null, Size.MEDIUM, null, Size.LARGE, null }, new SomePojo[] { null, new SomePojo("a"), null, new SomePojo("b"), null });
	...
	public static final class PojoWithArrayInList {
		...
		@Override
		public String toString() {
			return "PojoWithArrayInList " + "[boolArrayList=" + Arrays.asList(boolArrayList.get(0)) + ", charArrayList=" + Arrays.asList(charArrayList.get(0))
					+ ", shortArrayList=" + Arrays.asList(shortArrayList.get(0)) + ", intArrayList=" + Arrays.asList(intArrayList.get(0)) + ", longArrayList="
					+ Arrays.asList(longArrayList.get(0)) + ", floatArrayList=" + Arrays.asList(floatArrayList.get(0)) + ", doubleArrayList="
					+ Arrays.asList(doubleArrayList.get(0)) + "]";
		}
	}

	public void testArrayInList() throws IOException {
		Schema<PojoWithArrayInList> schema = getSchema(PojoWithArrayInList.class);

		Pipe.Schema<PojoWithArrayInList> pipeSchema = ((RuntimeSchema<PojoWithArrayInList>) schema).getPipeSchema();
	...
	public static final class PojoWithArrayPrimitiveInList {
		...
		@Override
		public String toString() {
			return "PojoWithArrayPrimitiveInList " + "[boolArrayList=" + Arrays.asList(boolArrayList.get(0)) + ", charArrayList=" + Arrays.asList(charArrayList.get(0))
					+ ", shortArrayList=" + Arrays.asList(shortArrayList.get(0)) + ", intArrayList=" + Arrays.asList(intArrayList.get(0)) + ", longArrayList="
					+ Arrays.asList(longArrayList.get(0)) + ", floatArrayList=" + Arrays.asList(floatArrayList.get(0)) + ", doubleArrayList="
					+ Arrays.asList(doubleArrayList.get(0)) + "]";
		}
	...
	public void testArrayPrimitiveInList() throws IOException {
		Schema<PojoWithArrayPrimitiveInList> schema = getSchema(PojoWithArrayPrimitiveInList.class);

		Pipe.Schema<PojoWithArrayPrimitiveInList> pipeSchema = ((RuntimeSchema<PojoWithArrayPrimitiveInList>) schema).getPipeSchema();
	...
	public static final class PojoWithArrayInMap {
		...
		@Override
		public String toString() {
			return "PojoWithArrayInMap " + "[boolHashMap=" + Arrays.asList(boolHashMap.get(0)) + ", charHashMap=" + Arrays.asList(charHashMap.get(0)) + ", shortHashMap="
					+ Arrays.asList(shortHashMap.get(0)) + ", intHashMap=" + Arrays.asList(intHashMap.get(0)) + ", longHashMap=" + Arrays.asList(longHashMap.get(0))
					+ ", floatHashMap=" + Arrays.asList(floatHashMap.get(0)) + ", doubleHashMap=" + Arrays.asList(doubleHashMap.get(0)) + "]";
		}
	}

	public void testArrayInMap() throws IOException {
		Schema<PojoWithArrayInMap> schema = getSchema(PojoWithArrayInMap.class);

		Pipe.Schema<PojoWithArrayInMap> pipeSchema = ((RuntimeSchema<PojoWithArrayInMap>) schema).getPipeSchema();
	...
	public static final class PojoWithArrayPrimitiveInMap {
		...
		@Override
		public String toString() {
			return "PojoWithArrayPrimitiveInMap " + "[boolHashMap=" + asList(boolHashMap.get(0)) + ", charHashMap=" + asList(charHashMap.get(0)) + ", shortHashMap="
					+ asList(shortHashMap.get(0)) + ", intHashMap=" + asList(intHashMap.get(0)) + ", longHashMap=" + asList(longHashMap.get(0)) + ", floatHashMap="
					+ asList(floatHashMap.get(0)) + ", doubleHashMap=" + asList(doubleHashMap.get(0)) + "]";
		}
	}

	public void testArrayPrimitiveInMap() throws IOException {
		Schema<PojoWithArrayPrimitiveInMap> schema = getSchema(PojoWithArrayPrimitiveInMap.class);

		Pipe.Schema<PojoWithArrayPrimitiveInMap> pipeSchema = ((RuntimeSchema<PojoWithArrayPrimitiveInMap>) schema).getPipeSchema();

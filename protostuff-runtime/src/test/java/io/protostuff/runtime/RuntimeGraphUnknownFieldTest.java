...
public class RuntimeGraphUnknownFieldTest extends AbstractTest {
	...
	public void testIt() throws IOException {
		...
		Client.ClassA aFromBuffer = deserializeGraph(data, Client.ClassA.class);

		assertNotNull(aFromBuffer.sa1);

		Client.ClassA aFromStream = deserializeGraph(new ByteArrayInputStream(data), Client.ClassA.class);

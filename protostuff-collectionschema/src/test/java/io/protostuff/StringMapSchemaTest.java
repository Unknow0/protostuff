...
public abstract class StringMapSchemaTest extends AbstractTest {
	...
	public abstract <T extends Map<String, String>> void mergeFrom(byte[] data, int offset, int length, T message, Schema<T> schema) throws IOException;
	...
	public abstract <T extends Map<String, String>> byte[] toByteArray(T message, Schema<T> schema) throws IOException;

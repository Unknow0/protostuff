...
public class JsonUnknownFieldTest {
	...
	public static final String UNKNOWN_NESTED_MESSAGE_FIELD = "{" + "\"field1\":42," + "\"unknownField\":{" + "\"a\":0," + "\"field1\":43," + "\"anotherNestedField\":{"
			+ "\"b\":0," + "\"c\":[1, 2, 3]," + "\"thirdNestedField\":{" + "\"e\":1," + "\"f\":\"foobar\"" + "}" + "}" + "}," + "\"field2\":\"testValue\"" + "}";

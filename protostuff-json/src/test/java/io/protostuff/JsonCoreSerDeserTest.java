...
public class JsonCoreSerDeserTest extends TestCase {
	...
	public void testUnknownScalarFields() throws Exception {
		String[] regularMessages = new String[] { "{\"int\":1,\"string\":\"string\",\"double\":555.444,\"id\":1}",
				"{\"int\":1,\"string\":\"string\",\"id\":2,\"double\":555.444}", "{\"id\":3,\"int\":1,\"string\":\"string\",\"double\":555.444}" };

		for (int i = 0; i < regularMessages.length; i++) {
			Baz b = new Baz();
			JsonIOUtil.mergeFrom(JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser(regularMessages[i]), b, b.cachedSchema(), false);
			assertTrue(i + 1 == b.getId());
		}

		String[] numericMessages = new String[] { "{\"4\":1,\"5\":\"string\",\"6\":555.444,\"1\":1}", "{\"4\":1,\"5\":\"string\",\"1\":2,\"6\":555.444}",
				"{\"1\":3,\"4\":1,\"5\":\"string\",\"6\":555.444}" };

		for (int i = 0; i < numericMessages.length; i++) {
			Baz b = new Baz();
			JsonIOUtil.mergeFrom(JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser(numericMessages[i]), b, b.cachedSchema(), true);
			assertTrue(i + 1 == b.getId());
		}
	}
	...
	public void testListIO() throws Exception {
		...
		JsonIOUtil.writeListTo(out, bars, SerializableObjects.bar.cachedSchema(), false);
		byte[] data = out.toByteArray();

		ByteArrayInputStream in = new ByteArrayInputStream(data);
		List<Bar> parsedBars = JsonIOUtil.parseListFrom(in, SerializableObjects.bar.cachedSchema(), false);
	...
	public void testListIOWithArrays() throws Exception {
		...
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		JsonIOUtil.writeListTo(out, foos, SerializableObjects.foo.cachedSchema(), false);
		byte[] data = out.toByteArray();

		ByteArrayInputStream in = new ByteArrayInputStream(data);
		List<Foo> parsed = JsonIOUtil.parseListFrom(in, SerializableObjects.foo.cachedSchema(), false);
	...
	public void testFooNullFields() throws Exception {
		...
		JsonIOUtil.mergeFrom(
				JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser("{\"someInt\":[null]" + ",\"someString\":[null]" + ",\"someBar\":[null]" + ",\"someEnum\":[null]"
						+ ",\"someBytes\":[null]" + ",\"someBoolean\":[null]" + ",\"someFloat\":[null]" + ",\"someDouble\":[null]" + ",\"someLong\":[null]}"),
	...
	public void testFooNullFieldsButFirst() throws Exception {
		...
		JsonIOUtil.mergeFrom(JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser(
				"{\"someInt\":[1,null]" + ",\"someString\":[\"string\",null]" + ",\"someBar\":[{},null]" + ",\"someEnum\":[1,null]" + ",\"someBytes\":[\"fw==\",null]" + // 0x7f
						",\"someBoolean\":[true,null]" + ",\"someFloat\":[10.01,null]" + ",\"someDouble\":[100.001,null]" + ",\"someLong\":[1000,null]}"),
				b, b.cachedSchema(), false);
	...
	public void testFooNullFieldsButMid() throws Exception {
		Foo b = new Foo();
		JsonIOUtil.mergeFrom(JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser("{\"someInt\":[null,1,null]" + ",\"someString\":[null,\"string\",null]"
				+ ",\"someBar\":[null,{},null]" + ",\"someEnum\":[null,1,null]" + ",\"someBytes\":[null,\"fw==\",null]" + // 0x7f
				",\"someBoolean\":[null,true,null]" + ",\"someFloat\":[null,10.01,null]" + ",\"someDouble\":[null,100.001,null]" + ",\"someLong\":[null,1000,null]}"), b,
				b.cachedSchema(), false);
	...
	public void testFooNullFieldsButLast() throws Exception {
		Foo b = new Foo();
		JsonIOUtil.mergeFrom(JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser(
				"{\"someInt\":[null,1]" + ",\"someString\":[null,\"string\"]" + ",\"someBar\":[null,{}]" + ",\"someEnum\":[null,1]" + ",\"someBytes\":[null,\"fw==\"]" + // 0x7f
						",\"someBoolean\":[null,true]" + ",\"someFloat\":[null,10.01]" + ",\"someDouble\":[null,100.001]" + ",\"someLong\":[null,1000]}"),
				b, b.cachedSchema(), false);
	...
	public void testFooNullFieldsButLast2() throws Exception {
		Foo b = new Foo();
		JsonIOUtil.mergeFrom(JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser("{\"someInt\":[null,null,1]" + ",\"someString\":[null,null,\"string\"]"
				+ ",\"someBar\":[null,null,{}]" + ",\"someEnum\":[null,null,1]" + ",\"someBytes\":[null,null,\"fw==\"]" + // 0x7f
				",\"someBoolean\":[null,null,true]" + ",\"someFloat\":[null,null,10.01]" + ",\"someDouble\":[null,null,100.001]" + ",\"someLong\":[null,null,1000]}"), b,
				b.cachedSchema(), false);
	...
	public void testBarNullFields() throws Exception {
		Bar b = new Bar();
		JsonIOUtil.mergeFrom(
				JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser("{\"someInt\":null" + ",\"someString\":null" + ",\"someBaz\":null" + ",\"someEnum\":null"
						+ ",\"someBytes\":null" + ",\"someBoolean\":null" + ",\"someFloat\":null" + ",\"someDouble\":null" + ",\"someLong\":null}"),
				b, b.cachedSchema(), false);
	...
	public void testBazNullFields() throws Exception {
		Baz b = new Baz();
		JsonIOUtil.mergeFrom(JsonIOUtil.DEFAULT_JSON_FACTORY.createJsonParser("{\"id\":null,\"name\":null,\"timestamp\":null}"), b, b.cachedSchema(), false);

...
public class JsonNumericCoreSerDeserTest extends TestCase {
	...
	public void testListIO() throws Exception {
		...
		JsonIOUtil.writeListTo(out, bars, SerializableObjects.bar.cachedSchema(), true);
		byte[] data = out.toByteArray();

		ByteArrayInputStream in = new ByteArrayInputStream(data);
		List<Bar> parsedBars = JsonIOUtil.parseListFrom(in, SerializableObjects.bar.cachedSchema(), true);

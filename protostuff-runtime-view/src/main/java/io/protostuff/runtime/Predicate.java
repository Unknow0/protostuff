...
public interface Predicate {
	...
	public enum Factories implements Predicate.Factory {
		...
		RANGE {
			@Override
			public Predicate create(String[] args) {
				return new Predicate.RANGE(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
			}
		},
		NOTRANGE {
			@Override
			public Predicate create(String[] args) {
				return new Predicate.NOTRANGE(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
			}
		};
	}
}
...
public class XmlCoreSerDeserTest {
	...
	public void testUnknownScalarFields() throws Exception {
		String[] regularMessages = new String[] {
				"<?xml version='1.0' encoding='UTF-8'?>" + "<Baz><int>1</int><string>string</string>" + "<double>555.444</double><id>1</id></Baz>",

				"<?xml version='1.0' encoding='UTF-8'?>" + "<Baz><int>1</int><string>string</string>" + "<id>2</id><double>555.444</double></Baz>",

				"<?xml version='1.0' encoding='UTF-8'?>" + "<Baz><id>3</id><int>1</int>" + "<string>string</string><double>555.444</double>"
	...
	public void testListIO() throws Exception {
		...
		XmlIOUtil.writeListTo(out, bars, SerializableObjects.bar.cachedSchema());
		byte[] data = out.toByteArray();

		ByteArrayInputStream in = new ByteArrayInputStream(data);
		List<Bar> parsedBars = XmlIOUtil.parseListFrom(in, SerializableObjects.bar.cachedSchema());
	...
	public void testListIOWithArrays() throws Exception {
		...
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		XmlIOUtil.writeListTo(out, foos, SerializableObjects.foo.cachedSchema());
		byte[] data = out.toByteArray();

		ByteArrayInputStream in = new ByteArrayInputStream(data);
		List<Foo> parsed = XmlIOUtil.parseListFrom(in, SerializableObjects.foo.cachedSchema());

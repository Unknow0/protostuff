...
public final class XmlIOFactoryUtil {
	...
	private static final String[] INPUT_FACTORY_IMPLS = new String[] { "com.fasterxml.aalto.stax.InputFactoryImpl", "com.ctc.wstx.stax.WstxInputFactory",
			"com.sun.xml.fastinfoset.stax.factory.StAXInputFactory", "com.sun.xml.internal.stream.XMLInputFactoryImpl" };

	// check the classpath for these output factory impls
	// sorted according to speed
	private static final String[] OUTPUT_FACTORY_IMPLS = new String[] { "com.fasterxml.aalto.stax.OutputFactoryImpl", "com.ctc.wstx.stax.WstxOutputFactory",
			"com.sun.xml.fastinfoset.stax.factory.StAXOutputFactory", "com.sun.xml.internal.stream.XMLOutputFactoryImpl" };

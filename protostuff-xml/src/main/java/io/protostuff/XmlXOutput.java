...
public final class XmlXOutput extends WriteSession implements Output, StatefulOutput {
	...
	static final byte[] START_SLASH_TAG = new byte[] { '<', '/' }, TRUE = new byte[] { 't', 'r', 'u', 'e' }, FALSE = new byte[] { 'f', 'a', 'l', 's', 'e' };
	...
	public XmlXOutput(LinkedBuffer head, OutputStream out, FlushHandler flushHandler, int nextBufferSize, Schema<?> schema) {
	...
	public void writeBool(int fieldNumber, boolean value, boolean repeated) throws IOException {
		...
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByteArray(START_SLASH_TAG, this,
				sink.writeByteArray(value ? TRUE : FALSE, this, sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByte(START_TAG, this, tail)))))));
	}
	...
	public void writeDouble(int fieldNumber, double value, boolean repeated) throws IOException {
		...
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByteArray(START_SLASH_TAG, this,
				sink.writeStrFromDouble(value, this, sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByte(START_TAG, this, tail)))))));
	}
	...
	public void writeFloat(int fieldNumber, float value, boolean repeated) throws IOException {
		...
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByteArray(START_SLASH_TAG, this,
				sink.writeStrFromFloat(value, this, sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByte(START_TAG, this, tail)))))));
	}
	...
	public void writeInt32(int fieldNumber, int value, boolean repeated) throws IOException {
		...
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByteArray(START_SLASH_TAG, this,
				sink.writeStrFromInt(value, this, sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByte(START_TAG, this, tail)))))));
	}
	...
	public void writeInt64(int fieldNumber, long value, boolean repeated) throws IOException {
		...
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByteArray(START_SLASH_TAG, this,
				sink.writeStrFromLong(value, this, sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByte(START_TAG, this, tail)))))));
	}
	...
	public void writeString(int fieldNumber, CharSequence value, boolean repeated) throws IOException {
		...
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByteArray(START_SLASH_TAG, this,
				sink.writeStrUTF8(value, this, sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByte(START_TAG, this, tail)))))));
	}
	...
	public <T> void writeObject(int fieldNumber, T value, Schema<T> schema, boolean repeated) throws IOException {
		...
		// start tag
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByte(START_TAG, this, tail)));

		schema.writeTo(this, value);

		// end tag
		tail = sink.writeByte(END_TAG, this, sink.writeStrAscii(name, this, sink.writeByteArray(START_SLASH_TAG, this, tail)));

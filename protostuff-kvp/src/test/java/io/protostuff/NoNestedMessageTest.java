...
public abstract class NoNestedMessageTest extends AbstractTest {
	...
	public static final Foo foo = newFoo(new Integer[] { 90210, -90210, 0 }, new String[] { "ab", "cd" }, new EnumSample[] { EnumSample.TYPE0, EnumSample.TYPE2 },
			new ByteString[] { ByteString.copyFromUtf8("ef"), ByteString.copyFromUtf8("gh") }, new Boolean[] { true, false }, new Float[] { 1234.4321f, -1234.4321f, 0f },
			new Double[] { 12345678.87654321d, -12345678.87654321d, 0d }, new Long[] { 7060504030201l, -7060504030201l, 0l });

	public static final Bar bar = new Bar(890, "bar", null, Bar.Status.STARTED, ByteString.copyFromUtf8("b2"), true, 150.051f, 2000.0002d, 303030303);

	public static final Bar negativeBar = new Bar(-12, "negativeBar", null, Bar.Status.STARTED, ByteString.copyFromUtf8("a1"), true, -130.031f, -1000.0001d, -101010101);

	static Foo newFoo(Integer[] someInt, String[] someString, EnumSample[] someEnum, ByteString[] someBytes, Boolean[] someBoolean, Float[] someFloat, Double[] someDouble,
			Long[] someLong) {

		return new Foo(Arrays.asList(someInt), Arrays.asList(someString), null, Arrays.asList(someEnum), Arrays.asList(someBytes), Arrays.asList(someBoolean),
				Arrays.asList(someFloat), Arrays.asList(someDouble), Arrays.asList(someLong));
	}

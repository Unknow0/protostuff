...
public final class LinkedBuffer {
	...
	public static LinkedBuffer wrap(byte[] array) {
		return new LinkedBuffer(array, 0, array.length);
	}

	/**
	 * Wraps the byte array buffer as a read-only buffer.
	 */
	public static LinkedBuffer wrap(byte[] array, LinkedBuffer appendTarget) {
		return new LinkedBuffer(array, 0, array.length, appendTarget);
	}

	/**
	 * Wraps the byte array buffer as a buffer.
	 */
	...
	* Wraps the byte array buffer as a read-only buffer.
	*/
	public static LinkedBuffer wrap(byte[] array, int offset, int length, LinkedBuffer appendTarget) {
		return new LinkedBuffer(array, offset, offset + length, appendTarget);
	}
	 ...
	 */
	public LinkedBuffer(int size, LinkedBuffer appendTarget) {
	...
	public LinkedBuffer(byte[] buffer, int start, int offset) {
		this.buffer = buffer;
		this.start = start;
		this.offset = offset;
	}
	...
	public LinkedBuffer(byte[] buffer, int start, int offset, LinkedBuffer appendTarget) {

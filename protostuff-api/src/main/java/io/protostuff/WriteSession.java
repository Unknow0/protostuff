...
public class WriteSession {
	...
	public interface FlushHandler {
		...
		int flush(WriteSession session, byte[] buf, int offset, int len, byte[] next, int nextoffset, int nextlen) throws IOException;

		int flush(WriteSession session, LinkedBuffer lb, byte[] buf, int offset, int len) throws IOException;
	}
	 ...
	 */
	public void reset() { // for override
	}

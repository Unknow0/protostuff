...
public class StringSerializerTest extends TestCase {
	...
	static final String[] targets = new String[] { three_byte_utf8, two_byte_utf8, alphabet, alphabet_to_upper, numeric, whitespace, foo, str_len_130, surrogatePairs,
			repeatChar('a', 0x800 - 16), repeatChar('a', 0x800 + 16), repeatChar('a', 0x8000 - 16), repeatChar('a', 0x8000 + 16) };

	static final String[] ascii_targets = new String[] { alphabet, alphabet_to_upper, numeric, whitespace, str_len_130, repeatChar('b', 0x800 - 16),
			repeatChar('b', 0x800 + 16), repeatChar('b', 0x8000 - 16), repeatChar('b', 0x8000 + 16) };

	static final int[] int_targets = new int[] { 0, 1, -1, 10, -10, 100, -100, 1000, -1000, 10001, -10001, 1110001, -1110001, 111110001, -111110001, 1234567890, -1234567890,
			Integer.MAX_VALUE, Integer.MIN_VALUE, };

	static final long[] long_targets = new long[] { 0l, 1l, -1l, 10l, -10l, 100l, -100l, 1000l, -1000l, 10001l, -10001l, 1110001l, -1110001l, 111110001l, -111110001l,
			11111110001l, -11111110001l, 1111111110001l, -1111111110001l, 111111111110001l, -111111111110001l, 11111111111110001l, -11111111111110001l, 1234567890123456789l,
			-1234567890123456789l, Long.MAX_VALUE, Long.MIN_VALUE, };

	static final float[] float_targets = new float[] { 0.0f, 10.01f, -10.01f, 1234.4321f - 1234.4321f, 56789.98765f, -56789.98765f, Float.MAX_VALUE, Float.MIN_VALUE };

	static final double[] double_targets = new double[] { 0.0d, 10.01d, -10.01d, 1234.4321d - 1234.4321d, 56789.98765d, -56789.98765d, 1234567890.0987654321d,
			-1234567890.0987654321d, Double.MAX_VALUE, Double.MIN_VALUE };

...
public final class YamlIOUtil {
	...
	private static final byte[] START_DIRECTIVE = new byte[] { (byte) '-', (byte) '-', (byte) '-', (byte) ' ' };
	...
	public static <T> byte[] toByteArray(T message, Schema<T> schema, LinkedBuffer buffer) {
		...
		try {
			output.tail = YamlOutput.writeTag(schema.messageName(), false, output.sink, output, output.sink.writeByteArray(START_DIRECTIVE, output, buffer));
